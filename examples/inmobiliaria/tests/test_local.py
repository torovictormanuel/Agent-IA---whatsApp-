...
async def main():
    ...
    print()
    print("=" * 55)
    print("   AgentKit — Test Local (Inmobiliaria)")
    print("=" * 55)
    print()
    print("  Escribe mensajes como si fueras un cliente.")
    print("  Prueba cosas como:")
    print("    'Busco un depto en alquiler en Villa Crespo'")
    print("    'Cuanto sale la P001?'")
    print("    'Quiero agendar visita a P002 el 2026-08-05 a las 11:00'")
    print()
